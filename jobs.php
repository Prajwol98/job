			...
			<div class="subnavbar-inner">
				<div class="container">
					<ul class="mainnav">
						...
						<li <?php echo $usershow; ?>><a href="javascript:void(0);"
								onclick="profile('<?php echo $log_email; ?>')"><i
									class="fa fa-user"></i><span>Profile</span> </a> </li>
						<li><a href="javascript:void(0);" onclick="notifications('<?php echo $log_email; ?>')"><i
									class="fa fa-bell"></i><span>Notifications</span> </a><span id="quick_note_num">
								<?php echo $note_label; ?>
							</span> </li>
						<?php echo $subnav_extras1; ?>
						<li class="active"><a href="javascript:void(0);" onclick="jobs('<?php echo $log_email; ?>')"><i
									class="fa fa-briefcase"></i><span>View Jobs</span> </a> </li>
		...
		$(document).ready(function (e) {
			...
			xmlhttp3.onreadystatechange = function () {
				if (xmlhttp3.readyState == 4 && xmlhttp3.status == 200) {
					document.getElementById('jobsrecommend').innerHTML = xmlhttp3.responseText;
				}
			}
			xmlhttp3.open('GET', '_parse/load_jobsrecommendation.php', true);
			xmlhttp3.send();
