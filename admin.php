...
<head>
	<meta charset="utf-8">
	<title>TalentTaps Admin</title>
	<?php include_once("_ext/default_head.php"); ?>
	<link href="_css/p.dashboard.css" rel="stylesheet">
</head>

<body class="owlbody owl-gradient">
	<div id="admin_cover" class="div-loader-cover" style="display:block;background: rgb(100 21 21);;">
		<br />
		<form class="lockscreen-credentials" role="form" id="logon" onsubmit="return false;">
			<div class="input-group">
				...
				<div style="width: 100%;line-height: 1px;" id="inputB">
					<input class="form-control inputBox" id="password" name="password"
						style="padding: 10px;width: 50%;text-align: center;font-size: 18px;" placeholder="Password"
				...
				<div class="login-extra" style="margin-bottom: 0;">
					<a style="font-size: 18px; color: darkgoldenrod;" href="../job">Return to home</a>
				</div>
			</div>
		</form>
	</div>
				...
				<div class="row">
					...
					<div class="span12 mobile-no-show">
						<div class="widget widget-nopad">
							<div id="relax" class="div-loader-cover">
	...
	<div class="footer" style="bottom: 0;position: fixed;right: 0;left: 0;"><?php include_once("_ext/footer.php"); ?>
	</div>
	<br /><br />
